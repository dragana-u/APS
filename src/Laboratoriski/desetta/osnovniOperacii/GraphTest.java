package Laboratoriski.desetta.osnovniOperacii;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i=0;i<n;i++){
            ...
            if(line.equals("CREATE")){
                ...
                String[] parts = line.split("\\s+");
                Set<Integer> list =  graph.getNeighbors(Integer.parseInt(parts[1]));
                System.out.println(list.contains(Integer.parseInt(parts[2])));
