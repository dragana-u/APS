...
public class BubbleSortDLL {
    ...
    static void sortDLL(DLL<Integer> list, int n){
        DLLNode<Integer> temp1 = list.getFirst();
        DLLNode<Integer> temp2 = temp1.succ;
        boolean swapped;
        while(temp1!=null){
            swapped = false;
            temp2 = temp1.succ;
...
//            }
    ...
    public static void main(String[] args) {
        ...
        String[] parts = input.get(1).split("\\s+");
