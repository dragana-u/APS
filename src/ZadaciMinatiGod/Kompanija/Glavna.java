package ZadaciMinatiGod.Kompanija;
...
public class Glavna
{
    public static void work(SLL<Task> toDo, SLL<Task> inProgress) {
        SLLNode<Task> temp1 = toDo.getFirst();
        int max = Integer.MIN_VALUE;
        SLLNode<Task> najvazen = temp1;
        while(temp1!=null){
            int importance = 2 * temp1.element.getHours() * temp1.element.getPriority();
            if(importance > max){
                najvazen = temp1;
                max = importance;
            }
        ...
        SLLNode<Task> temp2 = inProgress.getFirst();
        int min = Integer.MAX_VALUE;
        SLLNode<Task> najnevazen = temp2;
        while(temp2!=null){
            int importance = 2 * temp2.element.getHours() * temp2.element.getPriority();
            if(importance < min){
                najnevazen = temp2;
                min = importance;
            }
